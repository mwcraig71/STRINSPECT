...
const styles = StyleSheet.create({
  ...
  measureInput: { flex: 1, borderWidth: 1, borderRadius: 8, paddingHorizontal: 8, paddingVertical: 8, fontSize: 12, fontWeight: "700", textAlign: "right" },
  ...
  roadName: { flex: 1, borderWidth: 1, borderRadius: 6, paddingHorizontal: 8, paddingVertical: 7, fontSize: 12, fontWeight: "600" },
